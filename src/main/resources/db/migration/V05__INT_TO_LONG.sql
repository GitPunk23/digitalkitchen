ALTER TABLE ingredients MODIFY COLUMN id BIGINT;

ALTER TABLE meal_recipes MODIFY COLUMN recipe_id BIGINT;

ALTER TABLE recipe_ingredients MODIFY COLUMN id BIGINT;
...
ALTER TABLE recipe_tags MODIFY COLUMN id BIGINT;
...
ALTER TABLE steps MODIFY COLUMN id BIGINT;
ALTER TABLE steps MODIFY COLUMN recipe_id BIGINT;

ALTER TABLE tags MODIFY COLUMN id BIGINT;
